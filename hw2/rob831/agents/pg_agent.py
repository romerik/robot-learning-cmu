...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        # Step 1: Calculate Q-values
        q_values = self.calculate_q_vals(rewards_list)

        # Step 2: Calculate advantages
        advantages = self.estimate_advantage(observations, rewards_list, q_values, terminals)

        # Step 3: Update the policy using the calculated advantages
    ...
    def calculate_q_vals(self, rewards_list):
        ...
        for rewards in rewards_list:
            if not self.reward_to_go:
                ...
                trajectory_return = self._discounted_return(rewards)
                q_values.extend([trajectory_return[0]] * len(rewards))
            else:
    ...
    def estimate_advantage(self, obs, rewards_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            # Ensure that the predictions have the same mean and standard deviation as the current batch of q_values
