...
# Personal note to run the code

I have written functions for each question, specially questions with many experiments to get their graph. We just need to run each function while commenting the other part of the code in the main and it should work.